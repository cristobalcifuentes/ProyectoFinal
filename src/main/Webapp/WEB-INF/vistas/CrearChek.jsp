		...
		<div class="row">
			<div class="col s12 l5">
				...
				<div class="card-image">
          			<img src="/images/checkima.jpg">
          			</div>
					<div class="card-content ">
						<h2>Ingreso de CheckList</h2>
						<form action="/Profesional/crearChek" method="POST"
							name="formularioCheck">
							<div class="row">
								<div class="input-field col s6">
									<input id="chek" type="text" name="check" class="validate">
									<label for="check">Ingrese Check</label>
								</div>
							</div>
							<div class="row">
